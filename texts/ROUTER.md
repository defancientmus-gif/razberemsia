...
6. `texts/SELF_TUNING.md`, если задача трогает ИИ-функцию или классификацию — курс «правила + редкая переточка вместо ИИ-рутины».
...
Продуктовый голосовой агент с `rz-v283` работает через Router v1.1:

- `none` - простая запись/напоминание, без заметок и памяти;
- `light` - короткий вопрос или команда, минимум контекста;
- `notes` - нужна ссылка на заметку, поиск, открыть/прочитать/разобрать/удалить, или напоминание со ссылкой на контекст заметок;
